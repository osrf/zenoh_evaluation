...
async fn main() {
    ...
    let port_number = 7509 + (robot_number - 1) * 50;
    ...
    loop {
        ...
        println!(
            "{}: Putting generated quaternion to resource {}",
            node_name, resource
        );
