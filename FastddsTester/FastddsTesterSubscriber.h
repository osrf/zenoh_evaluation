...
/**
 * @file FastddsTesterSubscriber.h
 *
 */

#ifndef FASTDDSTESTERUBSCRIBER_H_
#define FASTDDSTESTERUBSCRIBER_H_
...
class FastddsTesterSubscriber
{
public:

    FastddsTesterSubscriber();

    virtual ~FastddsTesterSubscriber();
...
#endif /* FASTDDSTESTERUBSCRIBER_H_ */
